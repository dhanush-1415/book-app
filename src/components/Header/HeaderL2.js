    ...
    return (
        <>
            <Grid container justifyContent='space-evenly' sx={{ padding: '30px 0px 20px', width: '45%', margin: '0 auto' }}>
                <Grid onClick={(e) => {handlePath('/')}} item sx={{ cursor:'pointer', textAlign: 'center', color: isActive('/') ? '#f65d4e' : 'inherit' }}>
                    <Typography sx={{ fontWeight: 'bold', fontSize: '20px' }}>Home</Typography>
                    {isActive('/') && <FiberManualRecordIcon fontSize="small" />}
                </Grid>
                <Grid onClick={(e) => {handlePath('/products/best_selling')}} item sx={{ cursor:'pointer', textAlign: 'center', color: isActive('/products/best_selling') ? '#f65d4e' : 'inherit' }}>
                ...
                <Grid onClick={(e) => {handlePath('/products/latest_books')}} item sx={{ cursor:'pointer', textAlign: 'center', color: isActive('/products/latest_books') ? '#f65d4e' : 'inherit' }}>
                ...
                <Grid onClick={(e) => {handlePath('/products/coming_soon')}} item sx={{ cursor:'pointer', textAlign: 'center', color: isActive('/products/coming_soon') ? '#f65d4e' : 'inherit' }}>
                ...
                <Grid item sx={{ cursor:'pointer', textAlign: 'center', color: isActive('/products/genres') ? '#f65d4e' : 'inherit' }}>
